...
import {
  ...
  CalendarDays, Target, Bot, Compass, Flame, Radar, BookText, Languages, Briefcase,
...
export type Page =
  ...
  | 'bitacora' | 'ai-assistant' | 'memoria-ia' | 'english-hub' | 'oficina' | 'users';
...
const NAV_ITEMS: NavItem[] = [
  ...
  { page: 'oficina',      label: 'Oficina',     icon: Briefcase },
